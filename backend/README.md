...
## Project Structure
    ...
    ├── sparkling_recipe_de_78688  # Django project configurations
...
1. Clone this repo and `cd sparkling_recipe_de_78688`
...
2. Clone this repo and `cd sparkling_recipe_de_78688`
